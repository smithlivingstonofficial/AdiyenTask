...
# Book name
BOOK_NAME = "चित्रकथासंग्रहः-६"

# Path to the processed txt file
TXT_PATH = r"C:\Users\smith\Documents\SMITH\College\MCA\II-Semester\Internship\Adiyen\Task\Task 7\B15-8475\processed\8475.txt"
...
# Save JSON
with open('चित्रकथासंग्रहः-६.json', 'w', encoding='utf-8') as json_file:
    json.dump(structured_chunks, json_file, ensure_ascii=False, indent=2)

print(f"✅ Successfully created {len(structured_chunks)} structured chunks in चित्रकथासंग्रहः-६.json")
