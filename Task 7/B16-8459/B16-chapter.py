...
# Book name
BOOK_NAME = "पुराणकथासंग्रहः-1"

# Path to the processed txt file
TXT_PATH = r"C:\Users\smith\Documents\SMITH\College\MCA\II-Semester\Internship\Adiyen\Task\Task 7\B16-8459\processed\8459.txt"
...
# Save JSON
with open('पुराणकथासंग्रहः-1.json', 'w', encoding='utf-8') as json_file:
    json.dump(structured_chunks, json_file, ensure_ascii=False, indent=2)

print(f"✅ Successfully created {len(structured_chunks)} structured chunks in पुराणकथासंग्रहः-1.json")
